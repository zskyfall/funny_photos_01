package com.example.ginz.funnyphoto.CustomView;
...
public class BottomNavigationBehavior
    ...
    private IBottomMenuBehavior mIBottomMenuBehavior;

    public BottomNavigationBehavior(IBottomMenuBehavior iBottomMenuBehavior) {
